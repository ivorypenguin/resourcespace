...
// to hold ajax requests that should be canceled on a new div load, so as not to hold up the page turn (compact selectors)
ajaxCancelable=new Array();
...
function CentralSpaceLoad (anchor,scrolltop)
	{
	 ...
	 jQuery.each(ajaxCancelable,function() {
        this.abort();
    });
    ajaxCancelable.length = 0	;
