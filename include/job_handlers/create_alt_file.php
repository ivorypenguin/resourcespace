...
$output=run_command($shell_exec_cmd);
 ...
 if(file_exists($targetfile))
	...
	$message = ($job_success_lang!="")?$job_success_lang:$lang["alternative_file_created"] . ": " . str_replace(array('%ref','%title'),array($job_data['resource'],$resource['field' . $view_title_field]),$lang["ref-title"]) . "(" . $job_data["alt_name"] . "," . $job_data["alt_description"] . ")";
