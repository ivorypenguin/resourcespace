...
if (isset($anonymous_login) && ($username==$anonymous_login))
	...
	<a href="<?php echo $baseurl?>/pages/change_password.php"  onClick="return CentralSpaceLoad(this,true);"><?php } ?><?php echo ($userfullname=="" ? $username : $userfullname) ?><?php } /* end replacefullnamelink */?><?php if ($allow_password_change && !checkperm("p")) { ?></a><?php } ?></li>
...
<?php } ?>
		...
		<?php if ($top_nav_upload && checkperm("c")) { ?><li><a href="<?php echo $baseurl?>/pages/edit.php?ref=-<?php echo @$userref?>&amp;uploader=<?php echo $top_nav_upload_type ?>" onClick="return CentralSpaceLoad(this,true);"><?php echo $lang["upload"]?></a></li><?php } ?>
