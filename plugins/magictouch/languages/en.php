...
$lang["view_page_sizes"]="Preview sizes to use on the Resource View page<br />(the first matching size found will be used):";
$lang["preview_page_sizes"]="Preview sizes to use on the Full Screen Preview page<br />(the first matching size found will be used):";
