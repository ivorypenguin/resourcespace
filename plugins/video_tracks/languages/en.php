...
$lang["video_tracks_intro"]="This plugin allows you to upload video subtitles and audio tracks that will be made available for the user to have embedded in the downloaded file";
$lang["video_tracks_convert_vtt"]="Automatically convert subrip files (.srt) to VTT to allow diplay in video previews?";
...
$lang["video_tracks_download_export"] = "Add link to messages to allow download of exported files through ResourceSpace web interface";
