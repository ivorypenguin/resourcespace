...
?>
<div class="InpageNavLeftBlock"><a href="<?php echo $baseurl?>/plugins/rss2/pages/rssfilter.php?key=<?php echo $apikey;?>&search=<?php echo urlencode($search)?>&restypes=<?php echo urlencode($restypes)?>&archive=<?php echo $archive?>&starsearch=<?php echo $starsearch?>&skey=<?php echo urlencode($skey); ?>">&gt;&nbsp;<?php echo $lang["rss_feed_for_search_filter"]; ?></a></div>
<?php
}
