...
$lang["collectiondownloadinprogress"]='ожалуйста, подождите, пока создается архив с объектами. Это может занять какое-то время, зависящее от общего размера выбранных объектов.<br /><br />Чтобы продолжать работу, вы можете  <a href=\"home.php\" target=\"_blank\">> открыть новое окно броузера/a><br /><br />';
?>
