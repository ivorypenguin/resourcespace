...
<object type="application/x-shockwave-flash" data="<?php echo $baseurl_short?>lib/flashplayer/player_flv_maxi.swf" width="<?php echo $width?>" height="<?php echo $height?>" class="Picture">
