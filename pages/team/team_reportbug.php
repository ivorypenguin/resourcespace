...
if (isset($_REQUEST['submit']))
    ...
    <div class="BasicsBox"> 
        ...
        <form method="post" action="<?php echo $baseurl_short?>pages/team/team_reportbug.php"><input type="submit" name="submit" value="<?php echo $lang["reportbug-preparebutton"] ?>"/></form>
    </div>
